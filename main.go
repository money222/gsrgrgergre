...
func main() {
	...
	mysqlUser := os.Getenv("LilGtx@localhost")
	mysqlPassword := os.Getenv("dfjgiojgioerjgpoi")
	mysqlDatabaseName := os.Getenv("stranger")
	telegramBotKey := os.Getenv("646955206:AAGLeC0IGw4ceH_dvS7W1pCBb5Qv3Yd8750")
